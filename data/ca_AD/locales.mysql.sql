...
INSERT INTO `list` (`id`, `value`) VALUES ('de_IT', 'alemany (Itàlia)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_DE', 'anglès (Alemanya)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_AT', 'anglès (Àustria)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_BI', 'anglès (Burundi)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_DK', 'anglès (Dinamarca)');
INSERT INTO `list` (`id`, `value`) VALUES ('en_DM', 'anglès (Dominica)');
INSERT INTO `list` (`id`, `value`) VALUES ('en_ER', 'anglès (Eritrea)');
INSERT INTO `list` (`id`, `value`) VALUES ('en_SI', 'anglès (Eslovènia)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_FI', 'anglès (Finlàndia)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_IL', 'anglès (Israel)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_NL', 'anglès (Països Baixos)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_SE', 'anglès (Suècia)');
INSERT INTO `list` (`id`, `value`) VALUES ('en_CH', 'anglès (Suïssa)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('en_CY', 'anglès (Xipre)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('ar_PS', 'àrab (territoris palestins)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('be_BY', 'bielorús (Belarús)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('es_BZ', 'espanyol (Belize)');
INSERT INTO `list` (`id`, `value`) VALUES ('es_BO', 'espanyol (Bolívia)');
INSERT INTO `list` (`id`, `value`) VALUES ('es_BR', 'espanyol (Brasil)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('fo_DK', 'feroès (Dinamarca)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('fy', 'frisó occidental');
INSERT INTO `list` (`id`, `value`) VALUES ('fy_NL', 'frisó occidental (Països Baixos)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('it_VA', 'italià (Ciutat del Vaticà)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('os', 'osseta');
INSERT INTO `list` (`id`, `value`) VALUES ('os_GE', 'osseta (Geòrgia)');
INSERT INTO `list` (`id`, `value`) VALUES ('os_RU', 'osseta (Rússia)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('pt_GQ', 'portuguès (Guinea Equatorial)');
INSERT INTO `list` (`id`, `value`) VALUES ('pt_LU', 'portuguès (Luxemburg)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('pt_CH', 'portuguès (Suïssa)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('ru_BY', 'rus (Belarús)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('sw_CD', 'suahili (Congo - Kinshasa)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('tl', 'tagal');
INSERT INTO `list` (`id`, `value`) VALUES ('tl_PH', 'tagal (Filipines)');
...
INSERT INTO `list` (`id`, `value`) VALUES ('cs_CZ', 'txec (Txèquia)');
INSERT INTO `list` (`id`, `value`) VALUES ('ce', 'txetxè');
INSERT INTO `list` (`id`, `value`) VALUES ('ce_RU', 'txetxè (Rússia)');
